...
<template id="sidebar-extra">
  <div class="sidebar-extra">
    <h3>Navigation</h3>
    <h5><a href="#Definitions">Definitions</a></h5>
    <br>
    <h5><a href="#DoTHoT">DoT / HoT</a></h5>
    <ul>
        <li><a href="#Bleeding">Bleeding</a></li>
        <li><a href="#Burning">Burning</a></li>
        <li><a href="#Decay">Decay</a></li>
        <li><a href="#Lightburn">Lightburn</a></li>
        <li><a href="#Poisoned">Poisoned</a></li>
        <li><a href="#Regeneration">Regeneration</a></li>
        <li><a href="#Spellburn">Spellburn</a></li>
    </ul>
    <br>
    <h5><a href="#AfflictionAndControl">Affliction and Control</a></h5>
    <ul>
        ...
        <li><a href="#OffBalance">Off-Balance</a></li>
        <li><a href="#Panicked">Panicked</a></li>
    ...
    <br>
    <h5><a href="#BonusesAndPenalties">Bonuses & Penalties</a></h5>
    <ul>
        <li><a href="#AttackBonus">Attack Bonus</a></li>
        <li><a href="#AttackMalus">Attack Malus</a></li>
        <li><a href="#DamageBonus">Damage Bonus</a></li>
        <li><a href="#DamageMalus">Damage Malus</a></li>
        <li><a href="#DefenseBonus">Defense Bonus</a></li>
        <li><a href="#DefenseMalus">Defense Malus</a></li>
        <li><a href="#HealingBonus">Healing Bonus</a></li>
        <li><a href="#HealingMalus">Healing Malus</a></li>
        <li><a href="#MovementBonus">Movement Bonus</a></li>
        <li><a href="#MovementMalus">Movement Malus</a></li>
        <li><a href="#SaveBonus">Save Bonus</a></li>
        <li><a href="#SaveMalus">Save Malus</a></li>
    </ul>    
  </div>
</template>
...
{{ bb_from_file('bb_docs/rules/combat/status-effects.bb') }}
