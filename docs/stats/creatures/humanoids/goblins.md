...
<template id="sidebar-extra">
  <div class="sidebar-extra sidebar-extra-larger">
    ...
    <p>
    <ul>
    <li><a href="#goblin-fighter-25">Goblin Fighter</a></li>
    <li><a href="#goblin-hunter-25">Goblin Hunter</a></li>
    <li><a href="#goblin-shaman-25">Goblin Shaman</a></li>
    </ul>
    </p>
    </p>
    <hr>
...
## Level 25
{{ creature('data/creatures/humanoid/goblins/goblin-fighter-25.yaml') }}
{{ creature('data/creatures/humanoid/goblins/goblin-hunter-25.yaml') }}
{{ creature('data/creatures/humanoid/goblins/goblin-shaman-25.yaml') }}
